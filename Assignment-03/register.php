...
use App\Repository\FileStorage;
...
{
    $data = new RegistrationController(new FileStorage(),$_POST);
    $data->register();
}
// DB Connection
        ...
        <div class="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div class="bg-rose-300 text-white p-4 rounded"><?php echo $data->message ?></div>
                        ...
                        <form class="space-y-6" action="" method="POST" novalidate>
                            <div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-red-900"><?php echo $errors['name'] ?></p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-red-900"><?php echo $errors['email'] ?></p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-red-900"><?php echo $errors['password'] ?></p>
                                </div>
                            </div>
