      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 justify-between">
          ...
          @if(Route::has('login'))
                ...
                <div class="hidden sm:ml-6 sm:flex gap-2 sm:items-center">
                    ...
                    <div>
                        ...
                        <img
                            ...
                            src="{{ $user->image ? URL::asset('images/' . $user->image) : 'https://avatars.githubusercontent.com/u/831997' }}"
            ...
            @else
            <a class="m-2 px-6 py-3 rounded-md font-semibold bg-gray-800 hover:bg-black text-white" href="{{ route('login') }}">login</a>
            @endauth
